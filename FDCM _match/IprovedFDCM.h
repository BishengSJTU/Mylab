...
private:
    ...
    void lineMatch(Mat &dist, Mat &labelimg, double *LabelSlope, int maxlabel, Vec4f matchline, Vec4f curQline,
                   double *result, vector<FastLenOrder> Qorder, vector<Vec4f> Qlines);
