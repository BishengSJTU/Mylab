...
void IprovedFDCM::ondistTrans(Mat src, vector<FastLenOrder>Qorder, vector<Vec4f> Qlines, vector<FastLenOrder>order, vector<Vec4f> lines,bool shows, double* rst) {   //距离变换
    rst[0] = 0;
    int rows = src.rows;
    int cols = src.cols;
